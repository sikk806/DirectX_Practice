...
int WINAPI WinMain(HINSTANCE hInstance, HINSTANCE prevInstance, PSTR comdLine, int showCmd) {
...
InitDirect3DApp::InitDirect3DApp(HINSTANCE hIstance) :D3DApp(hIstance) {
...
void InitDirect3DApp::Draw(const GameTimer& gt) {
	...
	// 이러한 대기는 비효율적이다.
	// 후에 사용할 때는 조직화를 통해 굳이 쓸 필요가 없도록 한다.
	FlushCommandQueue();
}